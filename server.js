...
function bool(v, d = false) {
  ...
  if (typeof v === "string") return ["1","true","on","yes","si","sí"].includes(v.toLowerCase());
      ...
      if (Array.isArray(times) && times.length) {
        ...
        for (const t of ts) {
          ...
          await sh("ffmpeg", [
            ...
            "-frames:v", "1",
            "-vf", `scale=${effScale}:-2:flags=lanczos`,
        ...
        await sh("ffmpeg", [
          ...
          "-v", "error",
          "-i", inFile,
          "-vf", `fps=1/${every_sec},scale=${effScale}:-2:flags=lanczos`,
